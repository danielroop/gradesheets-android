 ...
 * {@link GradeSheetDetailActivity} representing item details. On tablets, the
 ...
 * selections.
 */
public class GradeSheetListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gradesheet_list);
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			Intent detailIntent = new Intent(this,
					GradeSheetDetailActivity.class);
